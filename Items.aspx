<%@ Page Title="Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Items.aspx.cs" Inherits="Safe_Catering.Items" %>
                         ...
                         <ItemTemplate>
                             <table class="nav-justified">
                                 <tr>
                                     ...
                                     <td>
                                         <asp:LinkButton ID="LinkButton1" runat="server" CommandName="date_dt" CommandArgument='<%# Eval("id") %>'  CssClass="btn btn-default" Text='<%# Eval("_date") %>' />
...
<div class="col-md-4">
    ...
    <asp:Button Text="Add Item" CssClass="btn btn-primary btn-block" OnClick="Unnamed_Click" runat="server" />
